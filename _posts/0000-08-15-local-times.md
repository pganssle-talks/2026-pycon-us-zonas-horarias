...
Tengo un post de blog en inglés que explica el tortuoso razonamiento detrás de esta decisión, pero me aseguré de que era la correcta.

Pero hay algo que quiero destacar: tienen una interfaz tipo `pytz` aquí; si quieres saber el desplazamiento o el nombre, puedes llamar a `.astimezone` sin argumentos, y te adjunta un `tzinfo` fijo para que tengas un datetime consciente.
